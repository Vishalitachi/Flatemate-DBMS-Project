...
<head>
  ...
  <title>ADD COMMON EXPENSES </title>
  <style>
     body { 
...
{
    extract($_POST);
   $sql = "INSERT INTO common_expenses (CATEGORY,STATUS,EXPENDITURE,DATE_OF_PAYMENT,MONTH)
   VALUES ('$cat', '$sat', '$exp', '$dop', '$mon')";
...
<form action="./inscom.php" method="post"> 
