...
{
    extract($_POST);
   $sql = "INSERT INTO apartment (APT_NO,M_ID,APT_NAME,LOCATION,APT_PHONE_NO)
   VALUES ('$aid', '$mid', '$name', '$loc', '$pho')";
...
<form action="./insapt.php" method="post"> 
...
<label>Apartment Phone No</label><br/>
